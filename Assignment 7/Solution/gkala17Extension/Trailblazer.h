...
//My Structure
struct Vertex {
	Vertex * parent; //Pointer to parent vertice
	double shortestDistanceYet; //Shortes distance from start vertice to this vertice
	Color color; //Color of vertice
	Loc location; //Location of vertice in grid
};

//Structure for vertice (Extension/Cluster)
struct Node {
	Node * parent;
	Loc location;
	int size;
